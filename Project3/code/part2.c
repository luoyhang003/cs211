...
int main(int argc, char* argv[]) {
	int id, p;
	unsigned long long int i, n, size;
	unsigned long long int low_value, high_value, proc_0;
	...
	unsigned long long int local_low, local_high;
	unsigned long long int local_size, local_first;
	char* local_marked;
